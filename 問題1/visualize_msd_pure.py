"""
visualize_msd_pure.py

目的: ブラウン運動の平均二乗変位（MSD: Mean Squared Displacement）を可視化（Pythonのみ版）
...
for i in range(n_runs):
    ...
    t, x, y, vx, vy = simulate_brownian_motion(T, m, gamma, kB, seed=i)
...
plt.tight_layout()
# 図をファイルに保存（解像度150dpi）
plt.savefig(os.path.join('figures', 'msd_plot_pure.png'), dpi=150)
# メモリを解放するために図を閉じる
plt.close()
